...
@section('content')
    ...
    <div class="container mt-3 pt-3 mb-1 pb-5">
      <h1 class="login-header text-center">Reset Password</h1>
      

    
      <form class="login" id="login-form" method="POST" action="{{ route('password.email') }}">
        @csrf
        ...
        <div id="div_id_login" class="form-group">
          <label for="email" class=" requiredField"> Email<span class="asteriskField">*</span> </label> 
            ...
            <button id="login_submit_button" class="btn btn-primary mb-3 login-test">{{ __('Email Password Reset Link') }}</button>
          </form>
        </div>
