                    ...
                    @foreach($blogs as $blog)
                        <article class="latest_post_single mb-5">
                            <div class="index-post-thumbnail"
                                 style="background-image:url({{ get_thumbnail_image($blog->cover_image) }});">
                            ...
                            <div class="post-content">
                                ...
                                <header class="entry-header">
                                    <h2 class="entry-title">
                                        <a href="{{ route('blog_detail', $blog->slug) }}" rel="bookmark">{{ $blog->title }}</a>
                                    </h2>
                                </header>
                                <div class="entry-content">
                                    <p>{!! substr($blog->introduction, 0, 250) !!}...</p>
                                    <div class="byline">
                                    ...
                                    <a href="{{ route('blog_detail', $blog->slug) }}" class="read-more">
                ...
                <div class="side_bar pl-5 ">
                    <form role="search" method="get" class="search-form" action="{{ route('blog_search') }}">
                        <div class="search_bar ">
                            <input type="search" class="form-control" placeholder="Search …" value="{{ isset($search) ? $search : null }}" name="search">
