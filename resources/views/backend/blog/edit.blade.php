    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <form action="{{ route('admin.blog.update', $blog->slug) }}" class="forms-sample needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('put')
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Create Blog Information</h4>
