    ...
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <input type="file" name="image" class="form-control dropify" data-height="230" id="image"
                data-default-file="{{ isset($community_section) ? static_asset($community_section->media_link) : null }}"
    ...
    <div class="col-lg-8">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="heading" id="heading" placeholder="Ex. Section Heading"
                value="{{ old('heading', isset($community_section) ? $community_section->heading : null) }}" required>
            @error('heading')
            <div class="text-danger">{{ $message }}</div>
            @enderror
            <div class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="title" id="title" placeholder="Ex. This is title"
                value="{{ old('title', isset($community_section) ? $community_section->title : null) }}" required>
            @error('title')
            <div class="text-danger">{{ $message }}</div>
            @enderror
            <div class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="short_description" id="short_description"
                ...
                value="{{ old('short_description', isset($community_section) ? $community_section->short_description : null) }}"
                required>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select id="content_type" class="select_2 form-control" name="content_type" onchange="appendContent()"
                ...
                <option value="{{ PlusSection::CONTENT_TYPE_BLOG }}" {{ isset($community_section) ? $community_section->
                ...
                <option value="{{ PlusSection::CONTENT_TYPE_PRODUCT }}" {{ isset($community_section) ?
                    $community_section->content_type == PlusSection::CONTENT_TYPE_PRODUCT ? 'selected' : null : null
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select id="content_id" class="select_2 form-control" name="content_id" required>
                ...
                <option value="{{ $content->id }}" {{ $community_section->content_id == $content->id ? 'selected' : null
