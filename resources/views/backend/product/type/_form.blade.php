    ...
    <div class="col-md-12 grid-margin grid-margin-lg-0">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="Ex. Marketing"
                value="{{ old('name', isset($type) ? $type->name : null) }}" required>
            @error('name')
    ...
    <div class="col-lg-12 grid-margin grid-margin-lg-0">
        <div class="form-check form-check-primary">
            <label class="form-check-label" for="is_active">
                <input type="checkbox" {{ isset($type) ? $type->status == 1 ? 'checked' : '' : '' }}
    ...
    {{-- <div class="col-lg-12 grid-margin grid-margin-lg-0">--}}
        {{-- <div class="form-check form-check-primary">--}}
            {{-- <label class="form-check-label">--}}
                {{-- <input type="checkbox" {{ isset($type) ? $type->show_in_mega == 1 ? 'checked' : '' : '' }}
                class="form-check-input" name="show_in_mega" id="show_in_mega">--}}
                {{-- Show on Mega Menu--}}
